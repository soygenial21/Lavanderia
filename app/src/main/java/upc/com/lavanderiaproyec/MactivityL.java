...
public class MactivityL extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
        ...
        Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
            ...
            public void onResult(@NonNull Status status) {
                if (status.isSuccess()) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.not_clase_session, Toast.LENGTH_SHORT).show();
                }
            }
        });
